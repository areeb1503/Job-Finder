  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gray-50 px-6 sm:px-8 md:px-12">
      ...
      <form
        ...
        className="bg-white m-4 p-6 rounded-lg shadow-lg w-full max-w-md"
      >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <p
              ...
              className={
                pwdFocus && !validPassword
                  ? "text-gray-600 text-sm mt-2 bg-gray-100 p-2 rounded-md"
                  : "hidden"
              }
            >
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-1">
              ...
              <span
                className={
                  validMatch && matchPassword ? "text-green-600 ml-2" : "hidden"
                }
              >
                <FontAwesomeIcon icon={faCheck} />
              </span>
              <span
                className={
                  validMatch || !matchPassword ? "hidden" : "text-red-600 ml-2"
                }
              >
                <FontAwesomeIcon icon={faTimes} />
              </span>
          ...
          {formData.role === "student" && (
            <div>
              ...
              >
                <Button
                  icon={<UploadOutlined />}
                  className="border border-orange-700 text-orange-700 w-full"
                >
                  Upload Resume
                </Button>
              </Upload>
          ...
          <button
            type="submit"
            disabled={!validMatch || !validPassword || loading}
      ...
      <div className="text-center">
        <p className="text-sm text-gray-600">
          ...
          <Link
            to="/login"
            className="font-semibold text-orange-700 hover:text-gray-600 transition"
          >
            Log In
          </Link>
        </p>
