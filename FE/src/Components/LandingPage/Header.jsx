      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div
            ...
            id="mobile-menu-2"
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 ml-32">
              <li>
                <NavLink
                  to="/"
                  className={({ isActive }) => //'isActive' is a in-built boolean variable that comes with the 'className' prop of NavLink
